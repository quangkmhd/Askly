...
from prompts.dynamic_prompts import DynamicPromptGenerator
...
class RAGPipeline:
    ...
    def ask(self, query: str, temperature: float = DEFAULT_TEMPERATURE,
        ...
        """
        Ask a question to the RAG system with enhanced query processing
        ...
        # Clean answer (remove prompt if present)
